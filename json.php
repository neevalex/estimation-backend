...
$json_array = [
    ...
    'wallcovering_step' => getGoogleSheetsData('1sd277Vpeed1ljpqrZV2issFAo3_qKiw-Kn1WRY-VwG8', 'wallcovering_step!A:I', 'top'),
    'interiorpainting_step' => getGoogleSheetsData('1sd277Vpeed1ljpqrZV2issFAo3_qKiw-Kn1WRY-VwG8', 'interiorpainting_step!A:L', 'top'),
    'completerenovation_step' => getGoogleSheetsData('1sd277Vpeed1ljpqrZV2issFAo3_qKiw-Kn1WRY-VwG8', 'completerenovation_step!A:K', 'top'),
